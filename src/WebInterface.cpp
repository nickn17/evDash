...
void handleRoot()
{
  ...
  text += "<option value='" + String(CAR_KIA_EV6_58) + "'" + selectedAttr(liveDataWebInt->settings.carType == CAR_KIA_EV6_58) + ">Kia EV6 2022 58kWh</option>";
  text += "<option value='" + String(CAR_KIA_EV6_77) + "'" + selectedAttr(liveDataWebInt->settings.carType == CAR_KIA_EV6_77) + ">Kia EV6 2022 77.4kWh</option>";
  ...
  text += "<option value='" + String(CAR_HYUNDAI_IONIQ5_58) + "'" + selectedAttr(liveDataWebInt->settings.carType == CAR_HYUNDAI_IONIQ5_58) + ">Hyundai Ioniq5 2022 58kWh</option>";
  ...
  text += "<option value='" + String(CAR_HYUNDAI_IONIQ5_77) + "'" + selectedAttr(liveDataWebInt->settings.carType == CAR_HYUNDAI_IONIQ5_77) + ">Hyundai Ioniq5 2022 77.4kWh</option>";
  text += "<option value='" + String(CAR_HYUNDAI_IONIQ6_77) + "'" + selectedAttr(liveDataWebInt->settings.carType == CAR_HYUNDAI_IONIQ6_77) + ">Hyundai Ioniq6 2023 77.4kWh</option>";
