...
MENU_ITEM menuItemsSource[MENU_SIZE] = {
    ...
    {MENU_REMOTE_UPLOAD_ABRP_LOG_SDCARD, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "Send MQTT data"},
    {MENU_REMOTE_UPLOAD_ABRP_LOG_SDCARD, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "MQTT server"},
    {MENU_REMOTE_UPLOAD_ABRP_LOG_SDCARD, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "MQTT id"},
    {MENU_REMOTE_UPLOAD_ABRP_LOG_SDCARD, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "MQTT user"},
    {MENU_REMOTE_UPLOAD_ABRP_LOG_SDCARD, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "MQTT passwd"},
    {MENU_REMOTE_UPLOAD_ABRP_LOG_SDCARD, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "MQTT topic"},
    {MENU_REMOTE_UPLOAD_CONTRIBUTE_ANONYMOUS_DATA_TO_EVDASH_DEV_TEAM, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "Contrib.anonymous data"},
