...
//   menu_id,                       parent_menu,        target_menu,    menu_str
    ...
    {VEHICLE_TYPE_NIROPHEV_8_9,     MENU_VEHICLE_TYPE,  MENU_NO_MENU,     "Kia Niro PHEV 8.9kWh (DEV)"},
    ...
    {VEHICLE_TYPE_VW_ID3_2021_77,   MENU_VEHICLE_TYPE,  MENU_NO_MENU,     "VW ID.3 2021 58 kWh (CAN)"},
    {VEHICLE_TYPE_BMWI3_2014_22,    MENU_VEHICLE_TYPE,  MENU_NO_MENU,     "VW ID.3 2021 77 kWh (CAN)"},
...
//  {MENU_WIFI,                     MENU_OTHERS,        MENU_NO_MENU,     "[dev] WiFi network"},
