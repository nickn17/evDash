...
const MENU_ITEM menuItemsSource[MENU_SIZE] = {
    ...
    {MENU_APP_VERSION, MENU_TOP_LEVEL, MENU_NO_MENU, "App version"},
    ...
    {VEHICLE_TYPE_SEAT, MENU_VEHICLE_TYPE, MENU_NO_MENU, "Seat"},
    {VEHICLE_TYPE_RENAULT, MENU_VEHICLE_TYPE, MENU_NO_MENU, "Renault"},
    {VEHICLE_TYPE_BMWI3_2014_22, MENU_VEHICLE_TYPE, MENU_NO_MENU, "BMW i3 2014 22kWh (DEV)"},
    {VEHICLE_TYPE_PEUGEOT_E208, MENU_VEHICLE_TYPE, MENU_NO_MENU, "Peugeot e-208"},

    {VEHICLE_TYPE_HYUNDAI_TOP, VEHICLE_TYPE_HYUNDAI, MENU_TOP_LEVEL, "<- parent menu"},
    {VEHICLE_TYPE_IONIQ_2018_28, VEHICLE_TYPE_HYUNDAI, MENU_NO_MENU, "Ioniq 28kWh (2018)"},
    {VEHICLE_TYPE_IONIQ_2018_PHEV, VEHICLE_TYPE_HYUNDAI, MENU_NO_MENU, "Ioniq PHEV 8.8kWh"},
    {VEHICLE_TYPE_KONA_2020_64, VEHICLE_TYPE_HYUNDAI, MENU_NO_MENU, "Kona 64kWh (2020)"},
    {VEHICLE_TYPE_KONA_2020_39, VEHICLE_TYPE_HYUNDAI, MENU_NO_MENU, "Kona 39kWh (2020)"},
    {VEHICLE_TYPE_HYUNDAI_IONIQ5_58_63, VEHICLE_TYPE_HYUNDAI, MENU_NO_MENU, "Ioniq5 58/63kWh"},
    {VEHICLE_TYPE_HYUNDAI_IONIQ5_72, VEHICLE_TYPE_HYUNDAI, MENU_NO_MENU, "Ioniq5 72.6kWh"},
    {VEHICLE_TYPE_HYUNDAI_IONIQ5_77_84, VEHICLE_TYPE_HYUNDAI, MENU_NO_MENU, "Ioniq5 77/84kWh"},
    {VEHICLE_TYPE_HYUNDAI_IONIQ6_53, VEHICLE_TYPE_HYUNDAI, MENU_NO_MENU, "Ioniq6 53kWh"},
    {VEHICLE_TYPE_HYUNDAI_IONIQ6_58_63, VEHICLE_TYPE_HYUNDAI, MENU_NO_MENU, "Ioniq6 58/63kWh"},
    {VEHICLE_TYPE_HYUNDAI_IONIQ6_77_84, VEHICLE_TYPE_HYUNDAI, MENU_NO_MENU, "Ioniq6 77/84kWh"},
    ...
    {VEHICLE_TYPE_KIA_EV6_58_63, VEHICLE_TYPE_KIA, MENU_NO_MENU, "Kia EV6 2022 58/63kWh"},
    {VEHICLE_TYPE_KIA_EV6_77_84, VEHICLE_TYPE_KIA, MENU_NO_MENU, "Kia EV6 2022 77/84kWh"},
    ...
    {VEHICLE_TYPE_SKODA_CITIGO_E_IV, VEHICLE_TYPE_SKODA, MENU_NO_MENU, "Skoda Citigo-e iV 36.8kWh"},
    ...
    {VEHICLE_TYPE_VW_EUP_36, VEHICLE_TYPE_VW, MENU_NO_MENU, "VW e-Up 36.8kWh"},

    {VEHICLE_TYPE_SEAT_TOP, VEHICLE_TYPE_SEAT, MENU_TOP_LEVEL, "<- parent menu"},
    {VEHICLE_TYPE_SEAT_MII_ELECTRIC_36, VEHICLE_TYPE_SEAT, MENU_NO_MENU, "Seat Mii Electric 36.8kWh"},

    {VEHICLE_TYPE_RENAULT_TOP, VEHICLE_TYPE_RENAULT, MENU_TOP_LEVEL, "<- parent menu"},
    {VEHICLE_TYPE_ZOE_22_DEV, VEHICLE_TYPE_RENAULT, MENU_NO_MENU, "Renault ZOE Z.E. 20 22kWh"},
    {VEHICLE_TYPE_ZOE_ZE40_41, VEHICLE_TYPE_RENAULT, MENU_NO_MENU, "Renault ZOE Z.E. 40 41kWh"},
    {VEHICLE_TYPE_ZOE_ZE50_52, VEHICLE_TYPE_RENAULT, MENU_NO_MENU, "Renault ZOE Z.E. 50 52kWh"},
    ...
    {MENU_CLEAR_STATS, MENU_OTHERS, MENU_NO_MENU, "Clear realtime driving stats"},
    {MENU_SDCARD, MENU_OTHERS, MENU_NO_MENU, "SD card"},
    {MENU_GPS, MENU_OTHERS, MENU_NO_MENU, "GPS"},
    {MENU_REMOTE_UPLOAD, MENU_OTHERS, MENU_NO_MENU, "Remote upload"},
    {MENU_VOLTMETER, MENU_OTHERS, MENU_NO_MENU, "Voltmeter INA3221"},
    {MENU_SPEED_CORRECTION, MENU_OTHERS, MENU_NO_MENU, "Speed correction:"},
    {MENU_RHD, MENU_OTHERS, MENU_NO_MENU, "Right hand drive"},
    {MENU_UNITS, MENU_OTHERS, MENU_NO_MENU, "Units"},
    ...
    {MENU_REMOTE_UPLOAD_UART, MENU_BOARD, MENU_NO_MENU, "HW serial (ext.)"},

    {MENU_UNIT_TOP, MENU_UNITS, MENU_OTHERS, "<- parent menu"},
    ...
    {MENU_SDCARD_ERASE_LOGS, MENU_SDCARD, MENU_NO_MENU, "Erase logs"},
    ...
    {MENU_REMOTE_UPLOAD_CONTRIBUTE_DATA_TO_EVDASH_DEV_TEAM, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "Contribute data"},
    ...
    {MENU_REMOTE_UPLOAD_TRACCAR_ENABLED, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "Send traccar"},
    {MENU_REMOTE_UPLOAD_TRACCAR_SERVER, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "Traccar server"},
    {MENU_REMOTE_UPLOAD_TRACCAR_PORT, MENU_REMOTE_UPLOAD, MENU_NO_MENU, "Traccar port"},
