...
const MENU_ITEM menuItemsSource[MENU_SIZE] = {
    ...
    {VEHICLE_TYPE_ZOE_22_DEV, MENU_VEHICLE_TYPE, MENU_NO_MENU, "Renault ZOE Z.E. 20 22kWh"},
    {VEHICLE_TYPE_ZOE_ZE40_41, MENU_VEHICLE_TYPE, MENU_NO_MENU, "Renault ZOE Z.E. 40 41kWh"},
    {VEHICLE_TYPE_ZOE_ZE50_52, MENU_VEHICLE_TYPE, MENU_NO_MENU, "Renault ZOE Z.E. 50 52kWh"},
