...
const MENU_ITEM menuItemsSource[MENU_SIZE] = {
    ...
    {MENU_ADAPTER_BLE_SELECT, MENU_ADAPTER_TYPE, MENU_NO_MENU, "Search BT3/4/WiFi adapter"},
    {MENU_ADAPTER_OBD2_BLE4, MENU_ADAPTER_TYPE, MENU_NO_MENU, "Obd2 Bluetooth4 (BLE4)"},
    {MENU_ADAPTER_OBD2_BT3, MENU_ADAPTER_TYPE, MENU_NO_MENU, "Obd2 Bluetooth3 classic"},
    {MENU_ADAPTER_OBD2_WIFI, MENU_ADAPTER_TYPE, MENU_NO_MENU, "Obd2 WiFi adapter [DEV]"},
    {MENU_ADAPTER_OBD2_NAME, MENU_ADAPTER_TYPE, MENU_NO_MENU, "[i] BT3/4 name:"},
    ...
    {MENU_SDCARD_JSON_TYPE, MENU_SDCARD, MENU_NO_MENU, "Json type"},
